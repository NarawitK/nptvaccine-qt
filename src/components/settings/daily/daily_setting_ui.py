...
class DailySettingWidget(QtWidgets.QWidget):
    ...
    def render_components(self):
        ...
        self.vaccine_name_setting = ListEditorComponent("ชื่อวัคซีนในเวชภัณฑ์ HOSXP ในโรงพยาบาล", self.viewmodel.vaccine_alias, ["เพิ่ม", "แก้ไข", "ลบ"])
        self.__vaccine_alias_label = QtWidgets.QLabel("ชื่อวัคซีนแสดงในโปรแกรมนี้")
